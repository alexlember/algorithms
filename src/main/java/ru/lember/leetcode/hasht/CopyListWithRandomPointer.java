...
public class CopyListWithRandomPointer {
    ...
    public Node copyRandomList(Node head) {
        ...
        while (current != null) {
            ...
            oldToNewNodeMap.put(current, newCurrent);
        ...
        while (previous != null && newPrevious != null) {
            newPrevious.random = oldToNewNodeMap.get(previous.random);
